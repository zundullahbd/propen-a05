...
import { FormState, createSales } from '../_actions/action';
...
const Form = () => {
	...
	const [formState, formAction] = useFormState<FormState, FormData>(createSales, {
		type: 'idle',
		errors: undefined,
	});
			...
			<m.form
				...
				<m.div
					...
					<div className='mb-2'>
						...
						<Input name='outlet' type='text' placeholder='Outlet' />
					</div>
