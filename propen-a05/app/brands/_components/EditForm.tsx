...
import { FormState, editBrand } from '../_action/action'
...
interface FormProps extends Brand {
	//
}
...
const Form: React.FC<FormProps> = ({
	...
	const [formState, formAction] = useFormState<FormState, FormData>(editBrand, {
		type: 'idle',
		errors: undefined,
	})
			...
			<m.form
				...
				<m.div
					...
					<div className='mb-2'>
						...
						<Input name='name' type='text' placeholder='Brand name' defaultValue={name} />
					</div>
				...
				<m.div
					...
					<div className='mb-2'>
						...
						<Input name='phone' type='text' placeholder='Brand phone' defaultValue={phone} />
					</div>
					...
					<div className='mb-2'>
						...
						<Input name='website' type='text' placeholder='Brand website' defaultValue={website} />
					</div>
					...
					<div className='mb-2'>
						...
						<Input
							name='service'
							type='text'
							placeholder='Service center link'
					...
					<div className='mb-2'>
						...
						<Input name='facebook' type='text' placeholder='Brand facebook' defaultValue={facebook || ''} />
					</div>
					...
					<div className='mb-4'>
						...
						<Input name='twitter' type='text' placeholder='Brand twitter' defaultValue={twitter || ''} />
					</div>
					...
					<div className='mb-4'>
						...
						<div
							...
							{file || image ? (
								<>
									<Image
										src={file ? URL.createObjectURL(file) : `/uploads/${image}`}
										alt='image'
										width={400}
										height={400}
