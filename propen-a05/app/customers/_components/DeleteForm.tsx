...
import { FormState, deleteCustomer } from '../_actions/action'
...
const Form: React.FC<FormProps> = ({ id }) => {
	...
	const [formState, formAction] = useFormState<FormState, FormData>(deleteCustomer, {
		type: 'idle',
		errors: undefined,
	})
