...
import { FormState, importCustomer } from '../_actions/action'
...
const Form: React.FC<FormProps> = ({ ...props }) => {
	...
	const [formState, formAction] = useFormState<FormState, FormData>(importCustomer, {
		type: 'idle',
		errors: undefined,
	})
