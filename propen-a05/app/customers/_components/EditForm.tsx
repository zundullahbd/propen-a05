...
import { FormState, editCustomer } from '../_actions/action'
...
interface FormProps extends Customer {
	//
}
...
const Form: React.FC<FormProps> = ({
	...
	const [formState, formAction] = useFormState<FormState, FormData>(editCustomer, {
		type: 'idle',
		errors: undefined,
	})
			...
			<m.form
				...
				<m.div
					...
					<div className='mb-2'>
						...
						<Input name='outlet' type='text' placeholder='Customer outlet' defaultValue={outlet} />
					</div>
					...
					<div className='mb-2'>
						...
						<Input name='number' type='text' placeholder='Customer number' defaultValue={number}/>
					</div>
					...
					<div className='mb-2'>
						...
						<Input name='name' type='text' placeholder='Customer name' defaultValue={name}/>
					</div>
					...
					<div className='mb-2'>
						...
						<Input name='code' type='text' placeholder='Customer code' defaultValue={code}/>
					</div>
